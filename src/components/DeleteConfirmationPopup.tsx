        ...
        <CardContent className="space-y-6 pt-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-border"> {/* Séparateur et padding */}
            ...
            <Button
              ...
              className={cn(
                "px-6 py-2 gap-2",
                "bg-red-700 hover:bg-red-800 text-white gap-2 bg-gradient-primary border-2 border-primary-hover text-black dark:text-white", // Un rouge plus profond pour le dark mode
                "dark:bg-red-600 dark:hover:bg-red-700 dark:text-white", // Un rouge similaire pour le light mode
